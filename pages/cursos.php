                        ...
                        <div class="widget catagory mb-50">
                            ...
                            <div class="catagories-menu">
                                <ul id="menu-content2" class="menu-content collapse show">                
                                    ...
                                    <?php
                                    $categorias = Painel::selectAll(TABLE_CATEGORIAS);
                ...
                <div class="col-12 col-md-8 col-lg-9">
                    <div class="shop_grid_product_area">
                        ...
                        foreach ($produtos as $key => $value) {
                            $categoriaNome = Painel::select(TABLE_CATEGORIAS, 'id = ?', array($value['categoria_id']))['slug'];
                            ?>
                            ...
                            <div class="col-12 col-sm-6 col-lg-4">
                                <div class="single-product-wrapper">
                                    ...
                                    <div class="product-description">
                                        ...
                                        rel="external" href="<?= $value['link']; ?>" actionBtn="comprar" class="btn essence-btn">Quero saber mais</a>
