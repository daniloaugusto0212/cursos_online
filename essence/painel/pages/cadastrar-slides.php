            ...
            if (isset($_POST['acao'])) {               
                ...
                if ($nome == '') {                    
                    ...
                    if(Painel::imagemValida($imagem) == false){
                        ...
                        include('../classes/lib/WideImage.php'); /*importa biblioteca WideImage para redimensionar imagem*/                       
                        $imagem = Painel::uploadFile($imagem);
                        WideImage::load('uploads/'.$imagem)->resize(100)->saveToFile('uploads/'.$imagem); /*redimensionando imagem*/ 
